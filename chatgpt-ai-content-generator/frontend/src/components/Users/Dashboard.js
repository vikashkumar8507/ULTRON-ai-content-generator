        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="mb-6 bg-white p-4 shadow rounded-lg">
            ...
            <div>
              ...
              <p className="mb-4">Next Billing Date: {data?.user?.nextBillingDate ? data?.user?.nextBillingDate: "No Billing Date Required"}</p>
            </div>
          </div>
          ...
          <div className="mb-6 bg-white p-4 shadow rounded-lg">
            ...
            <div>
              ...
              {data?.user?.subscriptionPlan === "Trial" && <p className="border mb-4 rounded w-full py-2 px-3 text-gray-700 leading-tight">Trial: 100 Monthly Request Provided</p>}
              {data?.user?.subscriptionPlan === "Free" && <p className="border mb-4 rounded w-full py-2 px-3 text-gray-700 leading-tight">Free: 5 Monthly Request Provided</p>}
              {data?.user?.subscriptionPlan === "Basic" && <p className="border mb-4 rounded w-full py-2 px-3 text-gray-700 leading-tight">Basic: 50 Monthly Request Provided</p>}
              {data?.user?.subscriptionPlan === "Premium" && <p className="border mb-4 rounded w-full py-2 px-3 text-gray-700 leading-tight">Premium: 100 Monthly Request Provided</p>}
              <Link
                to="/plans"
                  ...
                  <li key={index} className="py-4 hover:bg-gray-50 transition duration-150 ease-in-out">
                    <div className="flex flex-col sm:flex-row justify-between">
                      ...
                      <div className="flex items-center">
                        <p className={`text-sm font-semibold ${payment?.status === "sucessful" ? "text-green-500":"text-orange-500"}`}>
                          {payment?.status} 
                        </p>
